...
//константа foo находится в области видимости цикла for
...
print("x находится выше for, в видимой области")
...
greeting(greeting: "Привет", name: "Anna")
greeting(greeting: "Здрям", name: nil)
/*:
...
let car = Car(make: "Porcshe", model: "911", year: 2020)
print(car)
